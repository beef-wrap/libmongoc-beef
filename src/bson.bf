...
public static class libbson
{
	...
	*/
	...
	[CLink] public static extern bool bson_init_from_json(bson_t* bson, char* data, ssize_t len, bson_error_t* error);
	...
	*/
	[CLink] public static extern bool bson_init_static(bson_t* b, uint8_t* data, size_t length);
	...
	* using @b.
	*/
	[CLink] public static extern void bson_init(bson_t* b);
	...
	*/
	[CLink] public static extern void bson_reinit(bson_t* b);
	...
	*/
	[CLink] public static extern bson_t* bson_new_from_data(uint8_t* data, size_t length);
	...
	*/
	[CLink] public static extern bson_t* bson_new_from_buffer(uint8_t** buf, size_t* buf_len, bson_realloc_func realloc_func, void* realloc_func_ctx);
	...
	* Returns: A newly allocated bson_t that should be freed with bson_destroy().
	*/
	[CLink] public static extern bson_t* bson_sized_new(size_t size);
	...
	*/
	[CLink] public static extern bson_t* bson_copy(bson_t* bson);
	...
	*/
	[CLink] public static extern void bson_copy_to(bson_t* src, bson_t* dst);
	...
	* on dst.
	*/
	[CLink] public static extern void bson_copy_to_excluding(bson_t* src, bson_t* dst, char* first_exclude, ...); // BSON_GNUC_NULL_TERMINATED BSON_GNUC_DEPRECATED_FOR (bson_copy_to_excluding_noinit);
	...
	*/
	[CLink] public static extern void bson_copy_to_excluding_noinit(bson_t* src, bson_t* dst, char* first_exclude, ...); //BSON_GNUC_NULL_TERMINATED;

	struct va_list;

	[CLink] public static extern void bson_copy_to_excluding_noinit_va(bson_t* src, bson_t* dst, char* first_exclude, va_list args);
	...
	*/
	[CLink] public static extern void bson_destroy(bson_t* bson);

	[CLink] public static extern uint8_t* bson_reserve_buffer(bson_t* bson, uint32_t size);

	[CLink] public static extern bool bson_steal(bson_t* dst, bson_t* src);
	...
	*/
	[CLink] public static extern uint8_t* bson_destroy_with_steal(bson_t* bson, bool steal, uint32_t* length);
	...
	*/
	[CLink] public static extern uint8_t* bson_get_data(bson_t* bson);
	...
	*/
	[CLink] public static extern uint32_t bson_count_keys(bson_t* bson);
	...
	*/
	[CLink] public static extern bool bson_has_field(bson_t* bson, char* key);
	...
	*/
	[CLink] public static extern int bson_compare(bson_t* bson, bson_t* other);
	...
	*/
	[CLink] public static extern bool bson_equal(bson_t* bson, bson_t* other);
	...
	*/
	[CLink] public static extern bool bson_validate(bson_t* bson, bson_validate_flags_t flags, size_t* offset);
	...
	*/
	[CLink] public static extern bool bson_validate_with_error(bson_t* bson, bson_validate_flags_t flags, bson_error_t* error);
	...
	*/
	[CLink] public static extern bool bson_validate_with_error_and_offset(bson_t* bson,
	...
	*/
	[CLink] public static extern char* bson_as_json_with_opts(bson_t* bson, size_t* length, bson_json_opts_t* opts);
	...
	* Returns: A newly allocated string that should be freed with bson_free().
	*/
	[CLink] public static extern char* bson_as_canonical_extended_json(bson_t* bson, size_t* length);
	...
	* Returns: A newly allocated string that should be freed with bson_free().
	*/
	[CLink] public static extern char* bson_as_json(bson_t* bson, size_t* length); // BSON_GNUC_DEPRECATED_FOR(bson_as_legacy_extended_json);

	// `bson_as_legacy_extended_json` is a non-deprecated form of `bson_as_json`.
	[CLink] public static extern char* bson_as_legacy_extended_json(bson_t* bson, size_t* length);
	...
	* Returns: A newly allocated string that should be freed with bson_free().
	*/
	[CLink] public static extern char* bson_as_relaxed_extended_json(bson_t* bson, size_t* length);


	/* like bson_as_json() but for outermost arrays. */
	[CLink] public static extern char* bson_array_as_json(bson_t* bson, size_t* length); // BSON_GNUC_DEPRECATED_FOR(bson_array_as_legacy_extended_json);

	// `bson_array_as_legacy_extended_json` is a non-deprecated form of `bson_array_as_json`.
	[CLink] public static extern char* bson_array_as_legacy_extended_json(bson_t* bson, size_t* length);


	/* like bson_as_relaxed_extended_json() but for outermost arrays. */
	[CLink] public static extern char* bson_array_as_relaxed_extended_json(bson_t* bson, size_t* length);


	/* like bson_as_canonical_extended_json() but for outermost arrays. */
	[CLink] public static extern char* bson_array_as_canonical_extended_json(bson_t* bson, size_t* length);

	// bson_array_builder_t defines an API for building arrays.
	// BSON arrays require sequential numeric keys "0", "1", "2", ...
	public struct bson_array_builder_t { }
	...
	[CLink] public static extern bson_array_builder_t* bson_array_builder_new();
	...
	[CLink] public static extern bool bson_array_builder_build(bson_array_builder_t* bab, bson_t* out_);

	[CLink] public static extern void bson_array_builder_destroy(bson_array_builder_t* bab);

	[CLink] public static extern bool bson_append_value(bson_t* bson, char* key, int key_length, bson_value_t* value);

	// #define BSON_APPEND_VALUE(b, key, val) bson_append_value (b, key, (int) strlen (key), (val))

	[CLink] public static extern bool bson_array_builder_append_value(bson_array_builder_t* bab, bson_value_t* value);
	...
	*/
	[CLink] public static extern bool bson_append_array(bson_t* bson, char* key, int key_length, bson_t* array);

	// #define BSON_APPEND_ARRAY(b, key, val) bson_append_array (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_array(bson_array_builder_t* bab, bson_t* array);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_binary(bson_t* bson, char* key, int key_length, bson_subtype_t subtype, uint8_t* binary, uint32_t length);

	// #define BSON_APPEND_BINARY(b, key, subtype, val, len) bson_append_binary (b, key, (int) strlen (key), subtype, val, len)

	[CLink] public static extern bool bson_array_builder_append_binary(bson_array_builder_t* bab, bson_subtype_t subtype, uint8_t* binary, uint32_t length);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_bool(bson_t* bson, char* key, int key_length, bool value);

	// #define BSON_APPEND_BOOL(b, key, val) bson_append_bool (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_bool(bson_array_builder_t* bab, bool value);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_code(bson_t* bson, char* key, int key_length, char* javascript);

	// #define BSON_APPEND_CODE(b, key, val) bson_append_code (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_code(bson_array_builder_t* bab, char* javascript);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_code_with_scope(bson_t* bson, char* key, int key_length, char* javascript, bson_t* scope_);

	// #define BSON_APPEND_CODE_WITH_SCOPE(b, key, val, scope) \
	// bson_append_code_with_scope (b, key, (int) strlen (key), val, scope)

	[CLink] public static extern bool bson_array_builder_append_code_with_scope(bson_array_builder_t* bab, char* javascript, bson_t* scope_);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_dbpointer(bson_t* bson, char* key, int key_length, char* collection, bson_oid_t* oid);

	// #define BSON_APPEND_DBPOINTER(b, key, coll, oid) bson_append_dbpointer (b, key, (int) strlen (key), coll, oid)

	[CLink] public static extern bool bson_array_builder_append_dbpointer(bson_array_builder_t* bab, char* collection, bson_oid_t* oid);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_double(bson_t* bson, char* key, int key_length, double value);

	// #define BSON_APPEND_DOUBLE(b, key, val) bson_append_double (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_double(bson_array_builder_t* bab, double value);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_document(bson_t* bson, char* key, int key_length, bson_t* value);

	// #define BSON_APPEND_DOCUMENT(b, key, val) bson_append_document (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_document(bson_array_builder_t* bab, bson_t* value);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_document_begin(bson_t* bson, char* key, int key_length, bson_t* child);

	// #define BSON_APPEND_DOCUMENT_BEGIN(b, key, child) bson_append_document_begin (b, key, (int) strlen (key), child)

	[CLink] public static extern bool bson_array_builder_append_document_begin(bson_array_builder_t* bab, bson_t* child);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_document_end(bson_t* bson, bson_t* child);

	[CLink] public static extern bool bson_array_builder_append_document_end(bson_array_builder_t* bab, bson_t* child);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_array_begin(bson_t* bson, char* key, int key_length, bson_t* child);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_array_end(bson_t* bson, bson_t* child);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_int32(bson_t* bson, char* key, int key_length, int32_t value);

	// #define BSON_APPEND_INT32(b, key, val) bson_append_int32 (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_int32(bson_array_builder_t* bab, int32_t value);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_int64(bson_t* bson, char* key, int key_length, int64_t value);

	// #define BSON_APPEND_INT64(b, key, val) bson_append_int64 (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_int64(bson_array_builder_t* bab, int64_t value);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_decimal128(bson_t* bson, char* key, int key_length, bson_decimal128_t* value);

	// #define BSON_APPEND_DECIMAL128(b, key, val) bson_append_decimal128 (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_decimal128(bson_array_builder_t* bab, bson_decimal128_t* value);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_iter(bson_t* bson, char* key, int key_length, bson_iter_t* iter);

	// #define BSON_APPEND_ITER(b, key, val) bson_append_iter (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_iter(bson_array_builder_t* bab, bson_iter_t* iter);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_minkey(bson_t* bson, char* key, int key_length);

	// #define BSON_APPEND_MINKEY(b, key) bson_append_minkey (b, key, (int) strlen (key))

	[CLink] public static extern bool bson_array_builder_append_minkey(bson_array_builder_t* bab);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_maxkey(bson_t* bson, char* key, int key_length);

	// #define BSON_APPEND_MAXKEY(b, key) bson_append_maxkey (b, key, (int) strlen (key))

	[CLink] public static extern bool bson_array_builder_append_maxkey(bson_array_builder_t* bab);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_null(bson_t* bson, char* key, int key_length);

	// #define BSON_APPEND_NULL(b, key) bson_append_null (b, key, (int) strlen (key))

	[CLink] public static extern bool bson_array_builder_append_null(bson_array_builder_t* bab);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_oid(bson_t* bson, char* key, int key_length, bson_oid_t* oid);

	// #define BSON_APPEND_OID(b, key, val) bson_append_oid (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_oid(bson_array_builder_t* bab, bson_oid_t* oid);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_regex(bson_t* bson, char* key, int key_length, char* regex, char* options);

	// #define BSON_APPEND_REGEX(b, key, val, opt) bson_append_regex (b, key, (int) strlen (key), val, opt)

	[CLink] public static extern bool bson_array_builder_append_regex(bson_array_builder_t* bab, char* regex, char* options);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_regex_w_len(bson_t* bson, char* key, int key_length, char* regex, int regex_length, char* options);

	[CLink] public static extern bool bson_array_builder_append_regex_w_len(bson_array_builder_t* bab, char* regex, int regex_length, char* options);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_utf8(bson_t* bson, char* key, int key_length, char* value, int length);

	// #define BSON_APPEND_UTF8(b, key, val) bson_append_utf8 (b, key, (int) strlen (key), val, (int) strlen (val))

	[CLink] public static extern bool bson_array_builder_append_utf8(bson_array_builder_t* bab, char* value, int length);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_symbol(bson_t* bson, char* key, int key_length, char* value, int length);

	// #define BSON_APPEND_SYMBOL(b, key, val) bson_append_symbol (b, key, (int) strlen (key), val, (int) strlen (val))

	[CLink] public static extern bool bson_array_builder_append_symbol(bson_array_builder_t* bab, char* value, int length);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_time_t(bson_t* bson, char* key, int key_length, time_t value);

	// #define BSON_APPEND_TIME_T(b, key, val) bson_append_time_t (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_time_t(bson_array_builder_t* bab, time_t value);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_timeval(bson_t* bson, char* key, int key_length, timeval* value);

	// #define BSON_APPEND_TIMEVAL(b, key, val) bson_append_timeval (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_timeval(bson_array_builder_t* bab, timeval* value);
	...
	*/
	[CLink] public static extern bool bson_append_date_time(bson_t* bson, char* key, int key_length, int64_t value);

	// #define BSON_APPEND_DATE_TIME(b, key, val) bson_append_date_time (b, key, (int) strlen (key), val)

	[CLink] public static extern bool bson_array_builder_append_date_time(bson_array_builder_t* bab, int64_t value);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_now_utc(bson_t* bson, char* key, int key_length);

	// #define BSON_APPEND_NOW_UTC(b, key) bson_append_now_utc (b, key, (int) strlen (key))

	[CLink] public static extern bool bson_array_builder_append_now_utc(bson_array_builder_t* bab);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_timestamp(bson_t* bson, char* key, int key_length, uint32_t timestamp, uint32_t increment);

	// #define BSON_APPEND_TIMESTAMP(b, key, val, inc) bson_append_timestamp (b, key, (int) strlen (key), val, inc)

	[CLink] public static extern bool bson_array_builder_append_timestamp(bson_array_builder_t* bab, uint32_t timestamp, uint32_t increment);
	...
	* Returns: true if successful; false if append would overflow max size.
	*/
	[CLink] public static extern bool bson_append_undefined(bson_t* bson, char* key, int key_length);

	// #define BSON_APPEND_UNDEFINED(b, key) bson_append_undefined (b, key, (int) strlen (key))

	[CLink] public static extern bool bson_array_builder_append_undefined(bson_array_builder_t* bab);

	[CLink] public static extern bool bson_concat(bson_t* dst, bson_t* src);

	[CLink] public static extern bool bson_append_array_builder_begin(bson_t* bson, char* key, int key_length, bson_array_builder_t** child);

	// #define BSON_APPEND_ARRAY_BUILDER_BEGIN(b, key, child) \
	// bson_append_array_builder_begin (b, key, (int) strlen (key), child)

	[CLink] public static extern bool bson_array_builder_append_array_builder_begin(bson_array_builder_t* bab, bson_array_builder_t** child);

	[CLink] public static extern bool bson_append_array_builder_end(bson_t* bson, bson_array_builder_t* child);

	[CLink] public static extern bool bson_array_builder_append_array_builder_end(bson_array_builder_t* bab, bson_array_builder_t* child);
}