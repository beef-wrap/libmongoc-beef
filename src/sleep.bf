...
extension libmongoc
{
    ...
    */
    function void mongoc_usleep_func_t (int64_t usec, void *user_data);
    ...
    */
    [CLink] public static extern void mongoc_client_set_usleep_impl (mongoc_client_t *client, mongoc_usleep_func_t usleep_func, void *user_data);

    [CLink] public static extern void mongoc_usleep_default_impl (int64_t usec, void *user_data);
}