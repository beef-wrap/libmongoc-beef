...
extension libmongoc
{
	...
	*/
	public function void  mongoc_log_func_t(mongoc_log_level_t log_level, char* log_domain, char* message, void* user_data);
	...
	*/
	[CLink] public static extern void mongoc_log_set_handler(mongoc_log_func_t log_func, void* user_data);
	...
	*
	*/
	[CLink] public static extern void mongoc_log(mongoc_log_level_t log_level, char* log_domain, char* format, ...); // BSON_GNUC_PRINTF(3, 4);

	[CLink] public static extern void mongoc_log_default_handler(mongoc_log_level_t log_level, char* log_domain, char* message, void* user_data);
	...
	*/
	[CLink] public static extern char*  mongoc_log_level_str(mongoc_log_level_t log_level);
	...
	*/
	[CLink] public static extern void mongoc_log_trace_enable();
	...
	*/
	[CLink] public static extern void mongoc_log_trace_disable();
}